module Orcid
  class ProviderConfiguration
    ...
    def authentication_scope
      @authentication_scope ||= store.fetch('ORCID_APP_AUTHENTICATION_SCOPE') { "/authenticate,/orcid-works/create,/orcid-works/update,/read-public" }
    end
    ...
    def signin_via_json_url
      @signin_via_json_url ||= store.fetch('ORCID_TOKEN_URL') { "https://sandbox-1.orcid.org/signin/auth.json" }
    end
